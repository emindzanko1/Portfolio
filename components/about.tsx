  ...
  return (
    ...
    >
      ...
      <p className='mb-3'>
        ...
        <span className='font-medium'>.NET, React and MSSQL</span>. I am also familiar with Angular, Node.js, Next.js, Java, Kotlin, MySQL, PostgreSQL, 
        TypeScript, Knockout.js, C, C++. I am always looking to learn new technologies.
      </p>
      <p>
