...
export const metadata = {
  title: 'Emin | Personal Portfolio',
  description: 'Emin is a frontend developer',
}
  ...
  return (
    <html lang="en">
      ...
      bg-gray-50 text-gray-950 relative h-[5000px]`}>
         ...
         sm:w-[68.75rem]" ></div>
          <div className="bg-[#dbd7fb] absolute top-[-1rem] -z-10 left-[50rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem]
